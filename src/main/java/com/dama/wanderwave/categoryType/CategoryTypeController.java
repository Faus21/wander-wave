...
public class CategoryTypeController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "CategoryType found",
                         content = @Content(mediaType = "application/json",
                         schema = @Schema(implementation = CategoryTypeResponse.class))),
            @ApiResponse(responseCode = "404", description = "CategoryType not found",
                         content = @Content)
    })
    @GetMapping("/{id}")
    public ResponseEntity<CategoryTypeResponse> getCategoryTypeById(@PathVariable String id) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "List of CategoryTypes",
                         content = @Content(mediaType = "application/json",
                         schema = @Schema(implementation = CategoryTypeResponse.class)))
    })
    @GetMapping
    public ResponseEntity<List<CategoryTypeResponse>> getAllCategoryTypes() {
