...
ALTER TABLE report_status
    ADD CONSTRAINT uc_dcd9f68bb9e1800658b1b7f7f UNIQUE (name);
...
ALTER TABLE comment_reports
    ADD CONSTRAINT FK_COMMENT_REPORT FOREIGN KEY (comment_id) REFERENCES comments (comment_id);

ALTER TABLE comment_reports
    ADD CONSTRAINT FK_COMMENT_REPORTS_ON_REPORT FOREIGN KEY (report_id) REFERENCES reports (report_id);
...
ALTER TABLE post_reports
    ADD CONSTRAINT FK_POST_REPORT FOREIGN KEY (post_id) REFERENCES posts (post_id);

ALTER TABLE post_reports
    ADD CONSTRAINT FK_POST_REPORTS_ON_REPORT FOREIGN KEY (report_id) REFERENCES reports (report_id);
...
ALTER TABLE reports
    ADD CONSTRAINT FK_REVIEWED_BY_REPORT FOREIGN KEY (reviewed_by) REFERENCES users (user_id);
...
ALTER TABLE reports
    ADD CONSTRAINT FK_USER_REPORT FOREIGN KEY (reported_user_id) REFERENCES users (user_id);
