...
class ChatMessageServiceTest {
    ...
    void save_shouldSaveChatMessage_whenChatExists() {
        ...
        ChatMessage savedMessage = chatMessageService.save(ChatMessageRequest.builder().build());
    ...
    void save_shouldThrowException_whenChatDoesNotExist() {
        ...
        assertThatExceptionOfType(RuntimeException.class)
                .isThrownBy(() -> chatMessageService.save(ChatMessageRequest.builder().build()))
    ...
    void findChatMessages_shouldReturnMessagesBasedOnChatExistence(boolean chatExists, List<ChatMessage> expectedMessages) {
        ...
        List<ChatMessageResponse> messages = chatMessageService.findChatMessages("senderId", "recipientId");
